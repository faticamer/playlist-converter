        ...
        <div className="flex flex-col min-h-screen bg-spotifyBlack nunito-sans-regular">
            ...
            <div className='flex-1 flex justify-center items-center'>
                <div className='flex flex-col items-center justify-center h-[75vh] w-3/4 sm:w-2/3 mx-auto'>
                    <h1 className={`${styles.gradientText} text-transparent text-5xl new-amsterdam-bold tracking-wider animate-gradient pb-6`}>Playlistify</h1>
                    <p className='text-textLight text-2xl text-center mb-5'>Convert your favorite playlists from YouTube to Spotify!</p>
                    ...
                    <div className='flex flex-row w-1/3 items-center justify-evenly'>
                        <Link to='/convert' className='mt-6 p-4 text-white text-xl font-bold text-center rounded-full border-2 border-spotifyGreen bg-green-600 hover:bg-spotifyGreen transition-all duration-300 ease-in-out'>Get Started!</Link>
