...
import {getPlaylistItems, getTracksInfo} from '../service/server_calls'
  ...
  const handleInputField = async (event) => {
    ...
    if (val) {
      ...
      try {
        ...
        const finalTracksWithMarker = insertMarker(
    ...
    <div className="flex flex-col bg-spotifyBg min-h-screen">
      ...
      <div className="flex flex-row items-center justify-center">
        <div className="text-white w-1/3 h-[70vh] border-2 border-zinc-700 bg-spotifyDarkGrey rounded-2xl mt-6 ml-6 p-3 overflow-auto">
          <h1 className="pb-3 text-2xl border-b-2 border-green-800">
            Playlist content
          </h1>
          <div>
            {tracks.length > 0 ? (
              <InfoPane list={tracks} />
            ) : (
        ...
        <div className="flex flex-col items-center justify-center h-[75vh] md:w-1/2 sm:w-1/2">
          <div className="flex flex-col items-center justify-center w-3/5">
            <h1 className="font-light dark:text-white text-2xl pb-8 font-normal">
            ...
            <input
              ...
              className='p-4 w-full rounded-md bg-zinc-800 text-white text-center border border-green-800 focus:outline-none focus:bg-zinc-700 onfocus="this'
              id="convertInput"
            />
          </div>
