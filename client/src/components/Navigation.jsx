        ...
        <div className="flex">
              ...
              <div className="flex flex-row">
                ...
                >
                  ...
                  <span className="pl-2 text-2xl font-normal">
                    Welcome,{' '}
                    <span className="text-red-600">{userGoogle.username}</span>
                  </span>
                </a>
              </div>
            )}
            {user && !userGoogle && (
              <div className="flex flex-row">
                ...
                >
                  ...
                  <span className="pl-2 text-2xl font-normal">
                    Welcome,{' '}
                    <span className="text-spotifyGreen">{user.username}</span>
                  </span>
                </a>
              </div>
            )}
          ...
          {!user && !userGoogle && (
            <a href="/" className="text-3xl font-bold nunito-sans-bold ml-6">
              ...
              <span className="pl-2 text-2xl font-normal">Welcome, Guest!</span>
            </a>
          )}
        </div>
