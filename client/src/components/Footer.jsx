  ...
  return (
    <div className="flex flex-col items-center justify-center h-32">
      <p className="text-center text-sm font-light text-white w-full">
        Made with ❤️ by{' '}
        <a
          href="https://github.com/faticamer"
          target="_blank"
      ...
      <div className="flex items-center justify-center text-blue-500 gap-3 p-1 pb-3">
        <Link to={infoPath} className="text-sm hover:underline">
          About Playlistify
        </Link>
